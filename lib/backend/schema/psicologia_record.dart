...
class PsicologiaRecord extends FirestoreRecord {
  PsicologiaRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('psicologia');

  static Stream<PsicologiaRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PsicologiaRecord.fromSnapshot(s));

  static Future<PsicologiaRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => PsicologiaRecord.fromSnapshot(s));

  static PsicologiaRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PsicologiaRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PsicologiaRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PsicologiaRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PsicologiaRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PsicologiaRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPsicologiaRecordData({
  String? nome,
  String? desc,
  String? img,
  bool? like,
...
class PsicologiaRecordDocumentEquality implements Equality<PsicologiaRecord> {
  const PsicologiaRecordDocumentEquality();

  @override
  bool equals(PsicologiaRecord? e1, PsicologiaRecord? e2) {
  ...
  @override
  int hash(PsicologiaRecord? e) => const ListEquality().hash([
        e?.nome,
        e?.desc,
        e?.img,
        e?.like,
  ...
  @override
  bool isValidKey(Object? o) => o is PsicologiaRecord;
}
