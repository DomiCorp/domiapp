...
import 'pagamentopixanual_model.dart';
export 'pagamentopixanual_model.dart';

class PagamentopixanualWidget extends StatefulWidget {
  const PagamentopixanualWidget({super.key});

  @override
  State<PagamentopixanualWidget> createState() =>
      _PagamentopixanualWidgetState();
}

class _PagamentopixanualWidgetState extends State<PagamentopixanualWidget> {
  late PagamentopixanualModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentopixanualModel());
