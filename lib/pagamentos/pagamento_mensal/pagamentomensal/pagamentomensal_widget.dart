...
import 'pagamentomensal_model.dart';
export 'pagamentomensal_model.dart';

class PagamentomensalWidget extends StatefulWidget {
  const PagamentomensalWidget({super.key});

  @override
  State<PagamentomensalWidget> createState() => _PagamentomensalWidgetState();
}

class _PagamentomensalWidgetState extends State<PagamentomensalWidget> {
  late PagamentomensalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentomensalModel());
