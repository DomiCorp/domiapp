...
import 'cadastroprofissionalmedveterinario_model.dart';
export 'cadastroprofissionalmedveterinario_model.dart';

class CadastroprofissionalmedveterinarioWidget extends StatefulWidget {
  const CadastroprofissionalmedveterinarioWidget({super.key});

  @override
  State<CadastroprofissionalmedveterinarioWidget> createState() =>
      _CadastroprofissionalmedveterinarioWidgetState();
}

class _CadastroprofissionalmedveterinarioWidgetState
    extends State<CadastroprofissionalmedveterinarioWidget> {
  late CadastroprofissionalmedveterinarioModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CadastroprofissionalmedveterinarioModel());
