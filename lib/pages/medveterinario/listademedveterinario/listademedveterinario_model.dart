...
import 'listademedveterinario_widget.dart' show ListademedveterinarioWidget;
...
class ListademedveterinarioModel
    extends FlutterFlowModel<ListademedveterinarioWidget> {
  ...
  List<MedveterinarioRecord> simpleSearchResults = [];
