...
import 'cadastroprofissionalfisioterapia_model.dart';
export 'cadastroprofissionalfisioterapia_model.dart';

class CadastroprofissionalfisioterapiaWidget extends StatefulWidget {
  const CadastroprofissionalfisioterapiaWidget({super.key});

  @override
  State<CadastroprofissionalfisioterapiaWidget> createState() =>
      _CadastroprofissionalfisioterapiaWidgetState();
}

class _CadastroprofissionalfisioterapiaWidgetState
    extends State<CadastroprofissionalfisioterapiaWidget> {
  late CadastroprofissionalfisioterapiaModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CadastroprofissionalfisioterapiaModel());
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Plano',
                            hintText:
                                'Insira o plano escolhido EX: anual ou ,mensal',
                            hintStyle:
                                FlutterFlowTheme.of(context).bodyLarge.override(
                                      fontFamily: 'Readex Pro',
                                      letterSpacing: 0.0,
