...
import 'cadastroprofissionalnutricao_model.dart';
export 'cadastroprofissionalnutricao_model.dart';

class CadastroprofissionalnutricaoWidget extends StatefulWidget {
  const CadastroprofissionalnutricaoWidget({super.key});

  @override
  State<CadastroprofissionalnutricaoWidget> createState() =>
      _CadastroprofissionalnutricaoWidgetState();
}

class _CadastroprofissionalnutricaoWidgetState
    extends State<CadastroprofissionalnutricaoWidget> {
  late CadastroprofissionalnutricaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroprofissionalnutricaoModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await NutricaoRecord.collection
                                .doc(currentUserUid)
                                .set(createNutricaoRecordData(
