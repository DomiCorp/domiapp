...
import 'formapagesemestral_model.dart';
export 'formapagesemestral_model.dart';

class FormapagesemestralWidget extends StatefulWidget {
  const FormapagesemestralWidget({super.key});

  @override
  State<FormapagesemestralWidget> createState() =>
      _FormapagesemestralWidgetState();
}

class _FormapagesemestralWidgetState extends State<FormapagesemestralWidget> {
  late FormapagesemestralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormapagesemestralModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    if (FFAppState().metodoPagamento == 'Pix') {
                      _model.gerarpedido32 = await CriarPIXCall.call(
                      ...
                      if ((_model.gerarpedido32?.succeeded ?? true)) {
                        setState(() {
                          FFAppState().chavePix = CriarPIXCall.chavePix(
                            (_model.gerarpedido32?.jsonBody ?? ''),
                          ).toString();
