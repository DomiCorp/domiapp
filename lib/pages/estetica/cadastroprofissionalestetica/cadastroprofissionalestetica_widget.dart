...
import 'cadastroprofissionalestetica_model.dart';
export 'cadastroprofissionalestetica_model.dart';

class CadastroprofissionalesteticaWidget extends StatefulWidget {
  const CadastroprofissionalesteticaWidget({super.key});

  @override
  State<CadastroprofissionalesteticaWidget> createState() =>
      _CadastroprofissionalesteticaWidgetState();
}

class _CadastroprofissionalesteticaWidgetState
    extends State<CadastroprofissionalesteticaWidget> {
  late CadastroprofissionalesteticaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroprofissionalesteticaModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await EsteticaRecord.collection
                                .doc(currentUserUid)
                                .set(createEsteticaRecordData(
