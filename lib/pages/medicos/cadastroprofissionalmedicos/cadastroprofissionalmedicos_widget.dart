...
import 'cadastroprofissionalmedicos_model.dart';
export 'cadastroprofissionalmedicos_model.dart';

class CadastroprofissionalmedicosWidget extends StatefulWidget {
  const CadastroprofissionalmedicosWidget({super.key});

  @override
  State<CadastroprofissionalmedicosWidget> createState() =>
      _CadastroprofissionalmedicosWidgetState();
}

class _CadastroprofissionalmedicosWidgetState
    extends State<CadastroprofissionalmedicosWidget> {
  late CadastroprofissionalmedicosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroprofissionalmedicosModel());
