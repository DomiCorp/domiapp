...
import 'listade_medicos_widget.dart' show ListadeMedicosWidget;
...
class ListadeMedicosModel extends FlutterFlowModel<ListadeMedicosWidget> {
  ...
  List<MedicosRecord> simpleSearchResults = [];
