...
import 'listadeenfermagem_model.dart';
export 'listadeenfermagem_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EnfermagemRecord>>(
      stream: queryEnfermagemRecord(
        queryBuilder: (enfermagemRecord) => enfermagemRecord.orderBy('nome'),
      ),
                ...
                children: [
                  ...
                  if (FFAppState().PesquisaON)
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final enfermage = _model.simpleSearchResults.toList();
                          ...
                          return ListView.builder(
                            ...
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: enfermage.length,
                            itemBuilder: (context, enfermageIndex) {
                              final enfermageItem = enfermage[enfermageIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 0.0, 10.0, 20.0),
                                child: InkWell(
