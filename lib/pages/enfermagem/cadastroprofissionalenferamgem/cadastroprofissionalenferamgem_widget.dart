...
import 'cadastroprofissionalenferamgem_model.dart';
export 'cadastroprofissionalenferamgem_model.dart';

class CadastroprofissionalenferamgemWidget extends StatefulWidget {
  const CadastroprofissionalenferamgemWidget({super.key});

  @override
  State<CadastroprofissionalenferamgemWidget> createState() =>
      _CadastroprofissionalenferamgemWidgetState();
}

class _CadastroprofissionalenferamgemWidgetState
    extends State<CadastroprofissionalenferamgemWidget> {
  late CadastroprofissionalenferamgemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroprofissionalenferamgemModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await EnfermagemRecord.collection
                                .doc(currentUserUid)
                                .set(createEnfermagemRecordData(
