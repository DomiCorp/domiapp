...
import 'lertermodecondicaousuario_model.dart';
export 'lertermodecondicaousuario_model.dart';

class LertermodecondicaousuarioWidget extends StatefulWidget {
  const LertermodecondicaousuarioWidget({super.key});

  @override
  State<LertermodecondicaousuarioWidget> createState() =>
      _LertermodecondicaousuarioWidgetState();
}

class _LertermodecondicaousuarioWidgetState
    extends State<LertermodecondicaousuarioWidget> {
  late LertermodecondicaousuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LertermodecondicaousuarioModel());
