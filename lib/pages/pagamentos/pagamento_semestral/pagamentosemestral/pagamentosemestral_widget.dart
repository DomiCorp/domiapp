...
import 'pagamentosemestral_model.dart';
export 'pagamentosemestral_model.dart';

class PagamentosemestralWidget extends StatefulWidget {
  const PagamentosemestralWidget({super.key});

  @override
  State<PagamentosemestralWidget> createState() =>
      _PagamentosemestralWidgetState();
}

class _PagamentosemestralWidgetState extends State<PagamentosemestralWidget> {
  late PagamentosemestralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentosemestralModel());
