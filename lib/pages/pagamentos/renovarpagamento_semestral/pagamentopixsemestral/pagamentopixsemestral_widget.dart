...
import 'pagamentopixsemestral_model.dart';
export 'pagamentopixsemestral_model.dart';

class PagamentopixsemestralWidget extends StatefulWidget {
  const PagamentopixsemestralWidget({super.key});

  @override
  State<PagamentopixsemestralWidget> createState() =>
      _PagamentopixsemestralWidgetState();
}

class _PagamentopixsemestralWidgetState
    extends State<PagamentopixsemestralWidget> {
  late PagamentopixsemestralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagamentopixsemestralModel());
