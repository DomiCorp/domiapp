...
import 'cadastroprofissionaledfisica_model.dart';
export 'cadastroprofissionaledfisica_model.dart';

class CadastroprofissionaledfisicaWidget extends StatefulWidget {
  const CadastroprofissionaledfisicaWidget({super.key});

  @override
  State<CadastroprofissionaledfisicaWidget> createState() =>
      _CadastroprofissionaledfisicaWidgetState();
}

class _CadastroprofissionaledfisicaWidgetState
    extends State<CadastroprofissionaledfisicaWidget> {
  late CadastroprofissionaledfisicaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroprofissionaledfisicaModel());
